...
namespace Moonshine.RestfulService.Migrations
{
    ...
    [Migration("20170430085438_renaming survey status to IsActive")]
    partial class renamingsurveystatustoIsActive
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Moonshine.RestfulService.DA.Entities.Answers", b =>
                {
                    b.HasOne("Moonshine.RestfulService.DA.Entities.Questions", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Moonshine.RestfulService.DA.Entities.Questions", b =>
                {
                    b.HasOne("Moonshine.RestfulService.DA.Entities.Survey", "Survey")
                        .WithMany("Questions")
